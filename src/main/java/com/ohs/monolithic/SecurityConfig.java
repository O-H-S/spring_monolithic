...
import com.ohs.monolithic.user.jwt.JwtTokenFilter;
    ...
    @Bean
     SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                /*기본 설정은 IF_REQUIRED로, 스프링 시큐리티가 필요에 따라 세션을 생성합니다.
                        예를 들어, 사용자가 인증을 통과하면 스프링 시큐리티는 사용자의 세션을 생성하고 관리합니다. 하지만 세션을 사용하지 않는 요청에 대해서는 세션을 생성하지 않습니다.*/
        ...
        // 모든 요청에 대해서 호출되므로 적절한 matcher 설정이 필요함. (ex. 인덱스 페이지로 가면, 4번 호출됨)
